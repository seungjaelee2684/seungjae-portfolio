...
export const projectDto = [
    {
        ...
        game: [
            ...
            {
                id: "업적",
                content: "전반적인 서비스 구상과 웹페이지의 디자인, 기능 개발 및 운영을 담당하였습니다.\n일러스트 학원의 특성을 살려 형식적인 틀을 갖춰 디자인함과 동시에 너무 단조롭지 않게 UI를 구상하였습니다.\n사용자의 피드백을 통해 끊임없이 고민하고 수정하여 UX를 개선해왔습니다.\n검색엔진최적화(SEO)를 통해 검색엔진의 상단에 표출될 수 있도록 노력하였습니다."
            },
            {
                id: "트러블슈팅_01",
                content: "이미지 슬라이드 구현 중 현재 이미지가 fade-out되는 애니메이션 효과가 나타나지 않고 갑자기 사라지는 문제 발생\nstate를 한 개가 아니라 현재 이미지와 이전 이미지, 이 두 가지로 저장하고 관리하기로 결정\n현재 등장해야하는 이미지와 이전에 등장했던 이미지를 담아 관리하는 state를 만들어 계획한 대로 이미지들을 useEffect()와 setTimeout() 을 이용해 fade-in, fade-out 효과를 나눠서 보이도록 설정하여 해결완료!"
            },
            {
                id: "트러블슈팅_02",
